...
KAC=[cl,ki,kk,kc,kg,ki2,ki3,ki4,ki5,ki6]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
Bmid = kk.getProfile().mid
Cmid = kc.getProfile().mid
Dmid = kg.getProfile().mid
Emid = ki2.getProfile().mid
Fmid = ki3.getProfile().mid
Gmid = ki4.getProfile().mid
Hmid = ki5.getProfile().mid
Imid = ki6.getProfile().mid
...
#--------------------------------------------------------
		...
		cl.sendText(msg.to,"Xb1 Hadiir  \(ˆ▿ˆ)/")
                ...
                ki2.sendText(msg.to,"Xb6 Hadiir  \(ˆ▿ˆ)/")
                ki3.sendText(msg.to,"Xb7 Hadiir  \(ˆ▿ˆ)/")
                ki4.sendText(msg.to,"Xb8 Hadiir  \(ˆ▿ˆ)/")
                ki5.sendText(msg.to,"Xb9 Hadiir  \(ˆ▿ˆ)/")
                ki6.sendText(msg.to,"Xb10 Hadiir  \(ˆ▿ˆ)/")
...
#--------------------------------------------------------
			    ...
			    if target not in admin:
                                try:
                                    ...
                                    ki4.sendText(msg.to,"Succes BosQ")
                                    ki5.sendText(msg.to,"Succes BosQ")
                                    ki6.sendText(msg.to,"Succes BosQ")
                                except:
...
#--------------------------------------------------------
                ...
                if wait["blacklist"] == {}:
                    ...
                    ki4.sendText(msg.to,"nothing")
                    ki5.sendText(msg.to,"nothing")
                    ki6.sendText(msg.to,"nothing")
                else:
                    mc = ""
...
#--------------------------------------------------------
		...
		if msg.from_ in Creator:
				...
				if target not in admin:
                                    try:
                                        klist=[ki,kk,kc,kg,ki2,ki3,ki4,ki5,ki6]
                                        kicker=random.choice(klist)
