...
KAC=[cl,ki,kk,kc,kg,kb,ka,kl,ks,ko]
...
wait = {
    ...
    "cName6":"ᴺˣᴮᴼᵀᴘʀᴇsᴇɴᴛ-6",
    "cName7":"ᴺˣᴮᴼᵀᴘʀᴇsᴇɴᴛ-7",
    "cName8":"ᴺˣᴮᴼᵀᴘʀᴇsᴇɴᴛ-8",
    "cName9":"ᴺˣᴮᴼᵀᴘʀᴇsᴇɴᴛ-9",
    "cName10":"ᴺˣᴮᴼᵀᴘʀᴇsᴇɴᴛ-10",
    "Qr":True,
    "Timeline":True,
    "Contact":True,
    "lang":"JP",
...
#--------------------------------------------------------
		...
		kicker = [ki,kk,kc,kg,kb,ka,kl,ks,ko]
...
#--------------------------------------------------------
		...
		cl.sendText(msg.to,"Xb1 Hadiir  \(ˆ▿ˆ)/")
                ...
                kg.sendText(msg.to,"Xb5 Hadiir  \(ˆ▿ˆ)/")
                kb.sendText(msg.to,"Xb6 Hadiir  \(ˆ▿ˆ)/")
                ka.sendText(msg.to,"Xb7 Hadiir  \(ˆ▿ˆ)/")
                kl.sendText(msg.to,"Xb8 Hadiir  \(ˆ▿ˆ)/")
                ks.sendText(msg.to,"Xb9 Hadiir  \(ˆ▿ˆ)/")
                ko.sendText(msg.to,"Xb10 Hadiir  \(ˆ▿ˆ)/")
...
#--------------------------------------------------------
                ...
                kg.sendText(msg.to,"send contact")
...
#--------------------------------------------------------
			    ...
			    if target not in admin:
                                try:
                                    ...
                                    kg.sendText(msg.to,"Succes BosQ")
                                    kb.sendText(msg.to,"Succes BosQ")
                                    ka.sendText(msg.to,"Succes BosQ")
                                    kl.sendText(msg.to,"Succes BosQ")
                                    ks.sendText(msg.to,"Succes BosQ")
                                    ko.sendText(msg.to,"Succes BosQ")
                                except:
...
#--------------------------------------------------------
                ...
                if wait["blacklist"] == {}:
                    ...
                    kk.sendText(msg.to,"nothing")
                    kc.sendText(msg.to,"nothing")
                    kg.sendText(msg.to,"nothing")
                    kb.sendText(msg.to,"nothing")
                    ka.sendText(msg.to,"nothing")
                    kl.sendText(msg.to,"nothing")
...
#--------------------------------------------------------
		...
		if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        kg.sendText(msg.to,"Blacklist emang pantas tuk di usir")
                        kb.sendText(msg.to,"Blacklist emang pantas tuk di usir")
                        ka.sendText(msg.to,"Blacklist emang pantas tuk di usir")
                        kl.sendText(msg.to,"Blacklist emang pantas tuk di usir")
                        ks.sendText(msg.to,"Blacklist emang pantas tuk di usir")
                        ko.sendText(msg.to,"Blacklist emang pantas tuk di usir")
		else:
...
#--------------------------------------------------------
		...
		if msg.from_ in Creator:
				...
				if target not in admin:
                                    try:
                                        klist=[ki,kk,kc,kg,kb,ka,kl,ks,ko]
                                        kicker=random.choice(klist)
