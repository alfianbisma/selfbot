...
cl = LINETCR.LINE()
cl.login(token="EmNqVhadOHUlCHFnrbU2.VyJ6iKnWDMTkM+Do0igvSG.pDYhmp+UDfhTplxDrcPg+mPRgsH7d2vfaOOjgMOKDxE=")
#cl.login(token='')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
ki.login(token="En28jY0SUVVUwnXzAgj4.2EZvE/mw0OjwLVMr5AzsPa.uIyATuqygX4ZdriBSJDRuzXXg/vgVS1xfxPr+E91brE=")
#ki.login(token='')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
kk.login(token="EmuLhcEyCat3XeGInsI1.REd9l2nLC8+St2sjd9IQGq.yBgfKjzRWt0hTKLMxld96CPBHpKFqaxuITLwqnijbCo=")
#kk.login(token='')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
kc.login(token="EmMnRG5uLER33jbmXHZ0.I+DfCfJ6bvXZycRseDNkaa.as3YwmdY/IVOLKm6+RKSCrM2ajxVKL+Yaf2ebi7teNo=")
#kc.login(token='')
kc.loginResult()
...
owner="u5b35770e73cfaed07833c355f6705bd5","u7f4bffb2218e3e0f774bfc2406a9abda","u7fd29ae17122147632fc57cde32ed310"
