...
ki = LINETCR.LINE()
ki.login(token="EnFumZtZQSHnbFyggszc.vEO3bw+0kJdbjyDDyDZBha.CImnCs/RbooRuMsPjoE2q9yOLPJhj/GS4uxyMFS0JZY=")
#ki.login(token='')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
kk.login(token="EnY66Xy1fsWGEKKYxnsc.a5W5Uxa5CjR5SyEGh1wKda.AnOD3ci2E2g66r7rPLS6MhxfXkdv4agDMroi7CnMj8c=")
#kk.login(token='')
kk.loginResult()
...
╠═══════════════
║❂͜͡➣ᴀᴅᴍɪɴ ᴀᴅᴅ @{name}
║❂͜͡➣ᴀᴅᴍɪɴ ʀᴇᴍᴏᴠᴇ @{name}
║❂͜͡➣ᴀᴅᴍɪɴʟɪsᴛ
║❂͜͡➣ʙᴏᴛ ʀᴇsᴛᴀʀᴛ{danger}
║❂͜͡➣ᴊᴏɪɴ ɢʀᴏᴜᴘ:
╠════════════════
...
#--------------------------------------------------------
	    if mid in op.param3:
			...
			cl.updateGroup(G)
			cl.sendText(op.param1,"Hallo, Salam Kenal E1 Disini ❤😂")
                else:
