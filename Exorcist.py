...
cl = LINETCR.LINE() #Zefran
cl.login(qr=True)
cl.loginResult()

ki = LINETCR.LINE() #Zafro
ki.login(qr=True)
ki.loginResult()

kk = LINETCR.LINE() #Zero
kk.login(qr=True)
kk.loginResult()

kc = LINETCR.LINE() #Zhask
kc.login(qr=True)
kc.loginResult()

ks = LINETCR.LINE() #Zhack
ks.login(qr=True)
ks.loginResult()
...
❂͜͡➣Jam on/off
❂͜͡➣Tagall
❂͜͡➣Absen/Responsename
❂͜͡➣Banlist
❂͜͡➣Glist

════════════════
◀️[•ᴄᴏᴍᴍᴀɴᴅs ғᴏʀ ᴏᴡɴᴇʀ•]▶️
════════════════
❂͜͡➣Admin add @
❂͜͡➣Admin remove @
❂͜͡➣Bot add @
...
"""
KAC=[cl,ki,kk,kc,ks]
mid = cl.getProfile().mid #Zefran
Amid = ki.getProfile().mid #Zafro
Bmid = kk.getProfile().mid #Zero
Cmid = kc.getProfile().mid #Zhask
Dmid = ks.getProfile().mid #Zhack
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            elif ("Zero gn " in msg.text):
              if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("Zero gn ","")
                    ki.updateGroup(X)
                else:
                    ki.sendText(msg.to,"It can't be used besides the group.")
            elif ("Zhask gn " in msg.text):
              if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("Zhask gn ","")
                    kk.updateGroup(X)
                else:
                    kk.sendText(msg.to,"It can't be used besides the group.")
            elif ("Zhack gn " in msg.text):
              if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("Zhack gn ","")
                    kc.updateGroup(X)
                else:
            ...
            elif "Zero kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("_second kick ","")
                ki.kickoutFromGroup(msg.to,[midd])
            elif "Zhask kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("_third kick ","")
                kk.kickoutFromGroup(msg.to,[midd])
            elif "Zhack kick " in msg.text:
              if msg.from_ in admin:
            ...
            elif "Zero invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("sinvite ","")
                ki.findAndAddContactsByMid(midd)
                ki.inviteIntoGroup(msg.to,[midd])
            elif "Zhask invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("tinvite ","")
                kk.findAndAddContactsByMid(midd)
                kk.inviteIntoGroup(msg.to,[midd])
            elif "Zhack invite " in msg.text:
              if msg.from_ in admin:
    ...
    #-----------------=Selesai=------------------
            ...
            elif msg.text in ["Zero buka qr","Zero open qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Zhask buka qr","Zhask open qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Zhack open qr","Zhack buka qr"]:
                if msg.toType == 2:
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya Admin Yang bisa Gunain Perintah ini.")
            elif msg.text in ["Zero close qr","Zero tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Zhask tutup qr","Zhask close qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Zhack tutup qr","Sanji close qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in creator:
                ...
                if len(string.decode('utf-8')) <= 99999999999999999999:
                    profile = cl.getProfile()
                    profile.displayName = string
                    cl.updateProfile(profile)
...
#-----------------------------------------------
    ...
    #-------------Fungsi Tag All Finish---------------#
      ...
      #--------------Fungsi Broadcast Finish-----------#
            ...
            elif msg.text in ["Glist","glist","GLIST"]: #Melihat List Group
              if msg.from_ in admin:
                gids = cl.getGroupIdsJoined()
                h = ""
                for i in gids:
                  #####gn = cl.getGroup(i).name
                  h += "|•| %s Member\n" % (cl.getGroup(i).name   +"❂͜͡➣ "+str(len(cl.getGroup(i).members)))
                  cl.sendText(msg.to,"══════[List Group]══════\n"+ h +"Total Group :"+str(len(gids)))
                
            elif msg.text in ["GlistID","Glistid","GlistId","Glist+ID"]: #Melihat List Group + ID Groupnya (Gunanya Untuk Perintah InviteMeTo:)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
                h = ""
                for i in gid:
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Out all group","Out All Group","out all group","out All Group","Out all Group","Out All group"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in creator:
                gid = cl.getGroupIdsJoined()
  ...
  #-----------------End-----------
            elif msg.text in ["Ex katakan hi"]:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Zefran")
                ki.sendText(msg.to,"Zafro")
                kk.sendText(msg.to,"Zero")
                kc.sendText(msg.to,"Zhask")
                ks.sendText(msg.to,"Zhack")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
            elif msg.text in ["Speed","Sp","sp","speed"]:
              if msg.from_ in admin:
                start = time.time()
    ...
    #-------------Fungsi Bannlist Finish------------------#  
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Success to clear invitation user")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ᴇxᴏʀᴄɪsᴛ ᴛᴇᴀᴍ ʙᴏᴛs")
          ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ᴇxᴏʀᴄɪsᴛ ᴛᴇᴀᴍ ʙᴏᴛs")
          kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ᴇxᴏʀᴄɪsᴛ ᴛᴇᴀᴍ ʙᴏᴛs")
          kc.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ᴇxᴏʀᴄɪsᴛ ᴛᴇᴀᴍ ʙᴏᴛs")
          ks.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ks.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ᴇxᴏʀᴄɪsᴛ ᴛᴇᴀᴍ ʙᴏᴛs")
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ᴇxᴏʀᴄɪsᴛ ᴛᴇᴀᴍ ʙᴏᴛs")
          print "Like"
        except:
          pass
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Liked By ᴇxᴏʀᴄɪsᴛ ᴛᴇᴀᴍ ʙᴏᴛs")
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Creator : NyX\n line.me/ti/p/~nyx_on")
                    print "Like"
                except:
                    pass
            else:
