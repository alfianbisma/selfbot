...
cl = LINETCR.LINE()
cl.login(token="Eou6pbnNcTA7koIqQaU0.F9kA4xeIfhyY+fFn4Y7tea.pU1duR9y0bds3S1ClK8A/8E4o9YETxeAUdLWG0gkilk=")
cl.loginResult()

kk = LINETCR.LINE()#Assist1
kk.login(token="Eo1GfwMBTZMPP6ivCz5d.MoLtL7DqWtwuPW+WGWSodq.UqIgtJIPXBJ8vAFa6VZBjcVD2TG06+5A+m7udhnn16Y=")
kk.loginResult()

kc = LINETCR.LINE()#Assist2
kc.login(token="Eo3ooEKUoa86dr2Aq81e.UXlX4s1NJit2Wsbq42X5hG.tUdRIMc9eWXG+RPCBfBv1kRGY/nub/4LsllZaaHhn5w=")
kk.loginResult()
print "===[Login Success]==="
...
#--------------------------------------------------------
		...
		try:
		    ...
		    cl.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Auto Liked By AlfianBisma\nSupported By Alfian")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                cl.sendText(msg.to,"Succes BosQ")
            elif msg.text in ["Masuk","Join all","join all","Join All","join All","Kuy"]: #Panggil Semua Bot
              if msg.from_ in admin:
